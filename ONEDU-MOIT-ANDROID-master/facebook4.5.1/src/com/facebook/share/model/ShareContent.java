...
/**
 * Provides the base class for content to be shared. Contains all common methods
...
public abstract class ShareContent<P extends ShareContent, E extends ShareContent.Builder> implements ShareModel {
	...
	/**
	 * URL for the content being shared. This URL will be checked for app link
	 * meta tags for linking in platform specific ways.
	 * <p/>
	 * See documentation for <a
	 * href="https://developers.facebook.com/docs/applinks/">App Links</a>.
	 * 
	...
	public abstract static class Builder<P extends ShareContent, E extends Builder> implements ShareModelBuilder<P, E> {
		 ...
		 * 
		 * @param contentUrl
		 *            {@link android.net.Uri} representation of the content
		 *            link.
		 * @return The builder.
		 */
		 ...
		 * 
		 * @param peopleIds
		 *            {@link java.util.List} of Ids for people to tag.
		 * @return The builder.
		 */
		...
		/**
		 * Set the value to be added to the referrer URL when a person follows a
		 * link from this shared content on feed.
		 * 
		 * @param ref
