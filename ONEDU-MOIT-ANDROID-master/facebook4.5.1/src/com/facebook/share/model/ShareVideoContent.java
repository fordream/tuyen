 ...
 * 
 * A general use builder is available in {@link ShareVideoContent.Builder}.
 */
public final class ShareVideoContent extends ShareContent<ShareVideoContent, ShareVideoContent.Builder> implements ShareModel {
	...
	/**
	 * Builder for the {@link com.facebook.share.model.ShareVideoContent}
	 * interface.
	 */
	public static final class Builder extends ShareContent.Builder<ShareVideoContent, Builder> {
		 ...
		 * 
		 * @param previewPhoto
		 *            Preview {@link com.facebook.share.model.SharePhoto} for
		 *            the content.
		 * @return The builder.
		 */
		 ...
		 * 
		 * @param video
		 *            {@link com.facebook.share.model.ShareVideo}
		 * @return The builder.
		 */
		...
		public Builder readFrom(final ShareVideoContent model) {
			...
			return super.readFrom(model).setContentDescription(model.getContentDescription()).setContentTitle(model.getContentTitle()).setPreviewPhoto(model.getPreviewPhoto())
