...
public final class Profile implements Parcelable {
	...
	public static void fetchProfileForCurrentAccessToken() {
		...
		Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(), new Utility.GraphMeRequestWithCacheCallback() {
			...
			public void onSuccess(JSONObject userInfo) {
				...
				Profile profile = new Profile(id, userInfo.optString("first_name"), userInfo.optString("middle_name"), userInfo.optString("last_name"), userInfo.optString("name"), link != null ? Uri
						.parse(link) : null);
	...
	public boolean equals(Object other) {
		...
		return id.equals(o.id) && firstName == null ? o.firstName == null : firstName.equals(o.firstName) && middleName == null ? o.middleName == null : middleName.equals(o.middleName)
				&& lastName == null ? o.lastName == null : lastName.equals(o.lastName) && name == null ? o.name == null : name.equals(o.name) && linkUri == null ? o.linkUri == null : linkUri
				.equals(o.linkUri);
	}
