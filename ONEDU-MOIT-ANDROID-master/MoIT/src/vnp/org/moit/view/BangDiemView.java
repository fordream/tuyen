...
public class BangDiemView extends LinearLayout {
	...
	public BangDiemView(Context context) {
		super(context);
		CommonAndroid.getView(context, R.layout.bangdiem_new, this);
		init();
	}

	public BangDiemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		CommonAndroid.getView(context, R.layout.bangdiem_new, this);
		init();
	}

	public BangDiemView(Context context, AttributeSet attrs, int defStyleAttr) {
							...
							new ChonTruongOrHocSinhDialog(s1s2s3Activity, true,
								...
								public void onItemClickListener(
									...
									super.onItemClickListener(isStudent, idStr,
											name);
									studentId = idStr;
									CommonAndroid.setText(BangDiemView.this,
