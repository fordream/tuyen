...
public class NewFeedAdapter extends CursorAdapter {
	private Context context;
	private View empty;

	public NewFeedAdapter(Context context, View empty) {
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		return CommonAndroid.getView(context, R.layout.newfeeditem, null);
	}
